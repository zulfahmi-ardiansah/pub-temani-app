                            ...
                            <table class="table card-table table-hover table-vcenter text-nowrap table-special">
                                ...
                                <tbody>
                                    @foreach ($admDepartementList as $admDepartement)
                                        <tr>
                                            <td>
                                                <span class="avatar" style="background-image: url('{{ asset($admDepartement->de_icon) }}'); background-size: contain;"></span>
                                            </td>
                                            <td>
                                                {{ $admDepartement->de_name }}
                                            </td>
                                            <td>
                                                {{ $admDepartement->de_description }}
                                            </td>
                                            <td>
                                                {{ $admDepartement->de_category ? $admDepartement->de_category_rel->ca_name : '' }}
                                            </td>
                                            <td class="w-1">
                                                <form action="" method="POST">
                                                    {{ csrf_field() }}
